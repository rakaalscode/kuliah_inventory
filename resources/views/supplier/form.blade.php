            ...
            <div class="modal-content">
                ...
                <form id="customer-form" method="post" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-danger error-supplier" style="display: none"><ul></ul></div>
                        <div class="form-group row">
                            <div class="col-sm-1"></div>
                            <label class="col-sm-2 offset-1 col-form-label">Name</label>
                            <div class="col-sm-8">
                                <input type="hidden" id="id" class="form-control" name="id"/>
                                <input type="text" id="name" class="form-control" name="name" placeholder="Supplier name"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-1"></div>
