            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <i class="fa fa-plus fa-sm"></i> Add Supplier</a>
                    </div>
                    <div class="box-body">
                        <table id="DTsuppliers" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Email</th>
...
@push('js')
    ...
    <script>
        ...
        function addModal() {
            ...
            $(".error-supplier").css('display','none');
        ...
        $(function(){
                    ...
                    $.ajax({
                        ...
                        success : function(data) {
                            if($.isEmptyObject(data.errors)){
                                ...
                                $('#DTsuppliers').DataTable().ajax.reload();
                            }else{
            ...
            function printErrorMsg (msg) {
                $(".error-supplier").find("ul").html('');
                $(".error-supplier").css('display','block');
                $.each( msg, function( key, value ) {
                    $(".error-supplier").find("ul").append('<li>'+value+'</li>');
                });
            }
        });
