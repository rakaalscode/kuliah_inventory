            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <i class="fa fa-plus fa-sm"></i> Add Customer</a>
                    </div>
                    <div class="box-body">
                        <table id="DTcustomers" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Email</th>
...
@push('js')
    ...
    <script>
        ...
        function addModal() {
            ...
            $(".error-customer").css('display','none');
        ...
        $(function(){
            ...
            function printErrorMsg (msg) {
                $(".error-customer").find("ul").html('');
                $(".error-customer").css('display','block');
                $.each( msg, function( key, value ) {
                    $(".error-customer").find("ul").append('<li>'+value+'</li>');
                });
            }
        });
